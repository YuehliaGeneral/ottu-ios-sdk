...
**Apple Pay**: We provide a [seamless integration with Apple Pay]().
    DESC
    s.homepage     = "https://github.com/YuehliaGeneral/ottu-ios-sdk.git"
    s.license = { :type => 'Copyright', :text => <<-LICENSE
                   Copyright 2022
                   Permission is granted to Ottu
                  LICENSE
                }
    s.author             = { "YuehliaGeneral" => "developers@yuehlia.com" }
    s.source       = { :git => "https://github.com/YuehliaGeneral/ottu-ios-sdk.git", :tag => "#{s.version}" }
